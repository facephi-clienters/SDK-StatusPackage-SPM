...
let package = Package(
    ...
    targets: [
        ...
        url: "https://facephicorp.jfrog.io/artifactory/spm-pro-fphi/SDK/FPHISDKStatusComponent/2.9.0/statusComponent.zip",
        checksum: "3170096076d86323e2e0c98dde19a17d6dba852724e19c70d6adff5bd501dc8d"),
    ]
)
