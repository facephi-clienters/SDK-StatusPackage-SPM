...
let package = Package(
    ...
    targets: [
        ...
        url: "https://facephicorp.jfrog.io/artifactory/spm-pro-fphi/SDK/FPHISDKStatusComponent/2.8.0/statusComponent.zip",
        checksum: "739412684741948e8248bc2e9a18d83a6b4faeef804704647b58b6fed5fe179e"),
    ]
)
